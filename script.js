...
async function checker() {
  ...
  get(async (err, res) => {
    ...
    const template = (center) => `
            <div class="alert alert-light" role="alert" style="margin:5px ;">
...
function sendAlert() {
  ...
  // Play alert sound
  // var audio = new Audio(
  //   "https://sampleswap.org/samples-ghost/INSTRUMENTS%20(SINGLE%20SAMPLES)/Guitars/817[kb]strummy-g7-guitar.wav.mp3"
  // );
  // audio.play();
